...
// Add specific metadata for About page
export const metadata: Metadata = {
  title: "About BuildXpert - Leading Painting Contractors in Ireland",
  description:
    "Learn about BuildXpert's professional painting expertise, our skilled team, quality standards, and dedication to exceptional service for construction projects.",
  openGraph: {
    title: "About BuildXpert - Professional Painting Contractors",
    description:
      "Discover BuildXpert's journey to becoming a leading painting service provider for construction projects across Ireland.",
    url: "https://buildxpert.ie/about",
    type: "website",
  },
  alternates: {
    canonical: "https://buildxpert.ie/about",
  },
};
      ...
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            mainEntityOfPage: {
              "@type": "WebPage",
              "@id": "https://buildxpert.ie/about",
            },
            headline: "About BuildXpert - Professional Painting Services",
            description:
              "We are a professional painting company specializing in high-quality painting services for construction projects. With years of experience in the industry, we have built a reputation for excellence, reliability, and attention to detail.",
            image: "https://buildxpert.ie/images/AppImages/ContactUs.webp",
            publisher: {
              "@type": "Organization",
              name: "BuildXpert",
              logo: {
                "@type": "ImageObject",
                url: "https://buildxpert.ie/favicon.svg",
              },
            },
          }),
        }}
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="border border-border rounded-lg p-6 space-y-4">
                ...
                <p className="text-muted-foreground">
                  Our team brings years of experience and specialized knowledge
                  to every project, ensuring optimal results for various
